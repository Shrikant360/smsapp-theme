	...
	<div class="container<?php if (get_post_type() == 'thegem_pf_item' && $thegem_pf_data['fullwidth']) {
		...
		<div class="<?php echo esc_attr(implode(' ', $thegem_panel_classes)); ?>">
			...
			<div class="<?php echo esc_attr($thegem_center_classes); ?>">
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> hhhhn>

					<div class="entry-content post-content"> <?php   $featured_img_url = get_the_post_thumbnail_url(get_the_ID(),'full');  ?>
						<?php 
						...
						?>
							...
							<div class="post-meta date-color" style="display:none;">
			...
			<?php   	echo '<div class="sidebar col-lg-3 col-md-3 col-sm-12' . esc_attr($thegem_sidebar_classes) . '" role="complementary">';
			 	get_sidebar('page');
				echo '</div><!-- .sidebar -->';
			if (is_active_sidebar('page-sidebar') && $thegem_page_data['sidebar']['sidebar_position']) {
...
/*    display: none;*/
/*}*/
/*.post-tags-list, .post-related-posts{*/
/*	display:none;*/
/*}*/
</style>
<?php 
