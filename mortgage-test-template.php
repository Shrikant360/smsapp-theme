...
/**
 * Template Name: Mortgage test Page
...
$lp_img = 'https://360smsapp.com/wp-content/uploads/2026/08/';
...
<style>
    ...
    body:has(.sms-lp) p,
    body:has(.sms-lp) a,
    body:has(.sms-lp) span,
    body:has(.sms-lp) li,
    body:has(.sms-lp) label,
    body:has(.sms-lp) button,
    body:has(.sms-lp) input,
    body:has(.sms-lp) select,
    body:has(.sms-lp) textarea,
    body:has(.sms-lp) th,
    body:has(.sms-lp) td,
    .sms-lp,
    .sms-lp * {
    ...
    .sms-lp .lp-hero h1 {
        font-size: clamp(24px, 1.4rem + 1.5vw, 36px);
        line-height: 1.18;
        font-weight: 700;
    ...
    body > .iti--container,
    body > .country-select .country-list,
    .iti--container {
    ...
    @media (max-width: 767.98px) {
        ...
        .sms-lp .lp-stats .row > [class*="col-"]:nth-child(odd)::after {
            display: block;
            top: 22%;
            bottom: 22%;
            height: auto;
        ...
        .sms-lp .lp-stat-security {
            order: 3;
        }

        .sms-lp .lp-stat-reviews {
            order: 4;
        }
...
<header class="lp-sticky-header">
    <div class="lp-header-inner">
        ...
        <a href="#lp-demo-modal" class="btn btn-lp-coral lp-header-cta" data-bs-toggle="modal" data-bs-target="#lp-demo-modal">Book a Demo</a>
    </div>
</header>

<a href="#lp-demo-modal" class="lp-mobile-sticky-cta" data-bs-toggle="modal" data-bs-target="#lp-demo-modal">Book a Demo</a>
...
<main class="sms-lp">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center g-4 g-lg-5">
                <div class="col-lg-6 lp-hero-copy">
                    ...
                    <h1>Close More Loans Requests With <span class="accent">Salesforce SMS And Calls</span></h1>
                    ...
                    <a href="#lp-demo-modal" class="btn-lp" data-bs-toggle="modal" data-bs-target="#lp-demo-modal">Book a demo now <i class="bi bi-arrow-right" aria-hidden="true"></i></a>
                </div>
                <div class="col-lg-5 text-center lp-hero-visual-col">
                    <img src="https://360smsapp.com/wp-content/uploads/2026/08/Righ-Img.webp"
            ...
            <div class="container">
                <div class="lp-stats">
                    <div class="row g-0">
                        ...
                        <div class="col-6 col-md-3 lp-stat-reviews">
                            <div class="lp-stat">
                                <i class="bi bi-stars" aria-hidden="true"></i>
                                <div class="lp-stat-copy">
                                    <strong>1.2k+</strong>
                                    <span>AppExchange reviews</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3 lp-stat-security">
                            <div class="lp-stat">
            ...
            <div class="row align-items-center justify-content-center g-4 g-lg-5">
                ...
                <div class="col-lg-6">
                    <div class="row g-3 lp-logo-grid">
                        <?php
                        $logos = [
                            ['https://360smsapp.com/wp-content/uploads/2026/06/layer1ldpi.png', 'Volkswagen'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-21ldpi.png', 'Abbott'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-3ldpi-1.png', 'Accenture'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-4ldpi-1.png', 'Nasdaq'],
                            ['https://360smsapp.com/wp-content/uploads/2026/08/american-redcross.webp', 'American Red Cross'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-10ldpi.png', 'PWC'],
                        ];
    ...
    <section class="lp-features px-2" id="loan-lifecycle">
        <div class="container">
            <div class="text-center">
                ...
                <p class="lp-section-sub">Never leave your prospects and customers lost at any touchpoint.</p>
            </div>
            ...
            $steps_a = [
                ...
                [
                    ...
                    'Answer borrower questions over the phone or on SMS using itext while automating appointment confirmations, document checklists, and follow-up reminders.',
            ...
            $steps_b = [
                ...
                [
                    'Build Long-Term Borrower',
                    'Stay connected after closing with refinance outreach, referral campaigns, review requests, and personalized nurture communications through SMS, WhatsApp, and calls.',
    ...
    <section class="lp-results px-2 pb-0">
        <div class="container">
            <h2 class="lp-section-title text-center">Stay Connected with Your<br> Customers Across the Loan Lifecycle</h2>
            <div class="lp-results-bar">
                <div class="row g-0">
                    <div class="col-4">
                        <div class="lp-result-item">
                            <strong>51%</strong>
                            <span>Faster Speed-to-Lead</span>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="lp-result-item">
                            <strong>39%</strong>
                            <span>Reduction In Loan Processing Delays</span>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="lp-result-item">
                            <strong>34%</strong>
                            <span>Increase In Loan Closures</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="lp-compare-table">
                    ...
                    <tbody>
                        ...
                        $rows = [
                            ...
                            ['GDPR and HIPAA compliance', 'Yes', 'yes', 'Varies', 'no'],
    ...
    <section class="lp-mobile-cta d-md-none px-2" aria-label="Get started">
        <div class="container">
            <div class="lp-mobile-cta-card">
                ...
                <a href="#lp-demo-modal" class="lp-mobile-cta-btn" data-bs-toggle="modal" data-bs-target="#lp-demo-modal">Get Started</a>
            </div>
        </div>
    </section>
    ...
    <section class="lp-bottom px-2">
        <div class="container lp-final">
            ...
            <p>Keep borrowers informed, automate every stage of the lending journey, and empower your mortgage team to communicate faster—all from Salesforce.</p>
            <div class="d-flex flex-wrap justify-content-center gap-3">
                <a href="#lp-demo-modal" class="btn-lp" data-bs-toggle="modal" data-bs-target="#lp-demo-modal">Book a Personalized Demo</a>
                <a href="#lp-demo-modal" class="btn-lp btn-lp-outline" data-bs-toggle="modal" data-bs-target="#lp-demo-modal">Talk to a Mortgage Messaging Expert</a>
            </div>
        </div>
...
<script>
    (function() {
        ...
        document.querySelectorAll('[data-lp-steps]').forEach(function(root) {
            var buttons = root.querySelectorAll('.lp-step');
            var image = root.querySelector('[data-step-image-target]');
            ...
            buttons.forEach(function(btn) {
                btn.addEventListener('click', function() {
                    ...
                    var nextSrc = btn.getAttribute('data-step-image');
                    var nextAlt = btn.querySelector('h3');
                    if (!nextSrc || image.getAttribute('src') === nextSrc) return;

                    image.classList.add('is-fading');
                    window.setTimeout(function() {
                        image.setAttribute('src', nextSrc);
                        if (nextAlt) image.setAttribute('alt', nextAlt.textContent.trim());
