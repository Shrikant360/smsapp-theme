...
/**
 * Template Name: 360 SMS VS SMS Mogli
...
<header class="lp-sticky-header">
    <div class="lp-header-inner">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="lp-logo">
            <img src="https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/360_sms_-app_logo.png" alt="360 SMS App Logo" width="180" height="44" loading="eager">
        </a>
    ...
    <div class="container">
        ...
        <div class="row mb-5">
            <div class="col-lg-5 mx-lg-5 text-start"
                ...
                <img src="https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/360_sms_-app_logo.png" alt="360 SMS App Logo" class="img-fluid" style="max-height: 55px; width: auto;">
                </a>
            </div>
        </div>
        ...
        <div class="row align-items-center justify-content-between g-3">
            ...
            <div class="col-lg-5 mx-lg-5 text-start mb-5 mb-lg-0">
                ...
                <h1 class="fw-bold mb-5 text-dark-blue">360 SMS vs. Mogli SMS: <br> Which Is the Better Choice?</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-11">
                <div class="expertise-box bg-white shadow rounded-4 p-4 p-md-5 text-center mx-auto">
                    <h3 class="fw-bold text-dark-blue mb-3" style="font-size: 2.4rem;">Does Mogli SMS Have Everything You Need?</h3>
                    <p class="mb-0 text-secondary-dark mx-auto" style="font-size: 1.4rem !important; max-width: 800px; line-height: 1.6;">
                        Mogli SMS is a capable Salesforce messaging solution for SMS, MMS, and WhatsApp engagement. But if your business needs broader omnichannel communication, advanced AI capabilities, and enterprise-scale automation, you may eventually need a more comprehensive platform.
                    </p>
                </div>
            </div>
        </div>
...
<?php
$lp_client_logos = [
    ['https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-16ldpi-1.png', 'Morgan'],
    ['https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-21ldpi.png', 'Abbott'],
    ['https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-3ldpi-1.png', 'Unicef'],
    ['https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-10ldpi.png', 'Pagegroup'],
    ['https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-13ldpi.png', 'Lennar'],
    ['https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/American-red-Cross.png', 'American Red Cross'],
    // ['https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-9ldpi.png', 'Fairway'],
    // ['https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-5ldpi-1.png', 'ecornell'],

    // ['https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-4ldpi-1.png', 'MSD'],
...
<!-- ✅ Section 4: What Sets 360 SMS Apart from Mogli (Comparison Table) -->
<section class="comparison-section py-5">
    <div class="container text-center">
        <h2 class="fw-bold mb-4 mb-md-5 text-dark-blue">What Sets 360 SMS Apart from Mogli SMS</h2>
                ...
                <thead>
                    <tr>
                        ...
                        <th class="comp-360" scope="col">
                            <img src="https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/360_sms_-app_logo.png" alt="360 SMS App" width="120" height="36">
                        </th>
                        <th class="comp-mogli" scope="col">
                            <span style="font-size: 20px; font-weight: 800; color: #cc4e3c;">Mogli SMS</span>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="comp-mogli">Yes (2 channels only)</td>
                    </tr>
                    <tr>
                        <th class="comp-label" scope="row">Custom Link Shortening</th>
                        <td class="comp-360"><i class="bi bi-check-circle-fill" aria-hidden="true"></i> Yes</td>
                        <td class="comp-mogli">No</td>
                    </tr>
                    <tr>
                        <th class="comp-label" scope="row">Support</th>
                        <td class="comp-360 free-badge">Free</td>
                        <td class="comp-mogli">Paid</td>
                    </tr>
                </tbody>
            </table>
...
<style>
    ...
    .comparison-table .comp-mogli img {
        max-width: 100%;
        height: auto;
        max-height: 42px;
        object-fit: contain;
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <ul class="list-unstyled why-360-list mb-0">
                            ...
                            <li>
                                <i class="bi bi-check-circle-fill"></i>
                                <span>Never lose a prospect to slow responses.</span>
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
...
<!-- ✅ Section 6: Starting Fresh or Moving from Mogli? Choose 360 SMS -->
<section class="migration-section">
    <div class="container text-center">
        <h2 class="fw-bold mb-3 text-dark-blue">Starting Fresh or Moving from Mogli SMS?<br>Choose 360 SMS</h2>
...
$lp_testimonials = [
    [
        'logo'   => 'https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-13ldpi.png',
        'alt'    => 'Lennar Logo',
    ...
    [
        'logo'   => 'https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-16ldpi-1.png',
        'alt'    => 'Morgan Logo',
    ...
    [
        'logo'   => 'https://360smsapp.test360degreecloud.in/new-sms/wp-content/uploads/2026/08/Asset-21ldpi.png',
        'alt'    => 'Abbott Logo',
...
<section class="stories-section py-5">
    <div class="container text-center">
        <!--<h2 class="fw-bold mb-5 text-dark-blue">Here's What Former Mogli Customers Say</h2>-->
        ...
        <div class="row justify-content-center text-start mx-auto my-4" style="max-width: 900px;">
            ...
            <div class="col-md-6 mb-3 mb-md-0 ps-md-5">
                <ul class="list-unstyled upgrade-pointers-list mb-0">
                    ...
                    <li class="d-flex align-items-center mb-3">
                        ...
                        <span class="upgrade-list-text">Free migration from Mogli SMS</span>
                    </li>
                    <!--<li class="d-flex align-items-center mb-3">-->
                    <!--  <div class="upgrade-list-icon">-->
                    <!--    <i class="bi bi-check-lg"></i>-->
            ...
            <div class="col-md-6 ps-md-5">
                <ul class="list-unstyled upgrade-pointers-list mb-0">
                    ...
                    <!--    <i class="bi bi-check-lg"></i>-->
                    <!--  </div>-->
                    <!--  <span class="upgrade-list-text">Free migration from Mogli</span>-->
                    <!--</li>-->
                    <li class="d-flex align-items-center mb-3">
                        <div class="upgrade-list-icon">
                            <i class="bi bi-check-lg"></i>
