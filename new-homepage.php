...
/**
 * Template Name: 360 SMS - Ultimate Landing Page
 * Description:   Restructured — Bootstrap 5 standard, zero inline CSS, deduplicated classes.
 */
if (!defined('ABSPATH')) {
    exit;
}
...
<head>
    ...
    <style>
       ...
       ═══════════════════════════════════════════════════ */
        ...
        /* ═══════════════════════════════════════════════════
       2. REUSABLE UTILITY CLASSES (replace all inline)
       ═══════════════════════════════════════════════════ */
        /* -- Font sizes -- */
        .fs-11 {
        ...
        .bg-agent-cta {
            background: rgba(0, 87, 184, 0.3) !important;
        }
       ...
       ═══════════════════════════════════════════════════ */
        ...
        #three60-hp-root .t-links a:hover {
            color: #fff;
        }
       ...
       ═══════════════════════════════════════════════════ */
        ...
        #three60-hp-root .btn-nav-pri.zo {
            background: var(--zo);
        }

        #three60-hp-root .mobile-only-btn {
            display: none;
        }
        ...
        #three60-hp-root .mob-toggle .menu-close {
            display: none;
        }

        #three60-hp-root.mob-nav-open .mob-toggle .menu-ic {
            display: none;
        }

        #three60-hp-root.mob-nav-open .mob-toggle .menu-close {
            display: block;
        }
       ...
       ═══════════════════════════════════════════════════ */
        ...
        #three60-hp-root .hero.sf {
            background: linear-gradient(150deg, #EEF4FF 0%, #F7F7F5 65%);
        }

        #three60-hp-root .hero.zo {
            background: linear-gradient(150deg, #FEF0F2 0%, #F7F7F5 65%);
        }
       ...
       ═══════════════════════════════════════════════════ */
        ...
        #three60-hp-root .gs-tab:hover {
            background: var(--bg2) !important;
        }

        #three60-hp-root .gs-tab.active-tab {
            background: #fff;
            opacity: 1 !important;
        }

        #three60-hp-root .gs-panel {
            display: none;
        }

        #three60-hp-root .gs-panel.active {
            display: block;
        }
        ...
        .gs-bullets.sf li::before {
            color: var(--sf);
        }

        .gs-bullets.zo li::before {
            color: var(--zo);
        }

        /* ═══════════════════════════════════════════════════
       15. CTA BARS (Section 10, 13)
       ═══════════════════════════════════════════════════ */
        .cta-bar-h {
            font-size: 34px;
            letter-spacing: -1px;
       ...
       ═══════════════════════════════════════════════════ */
        @media (max-width: 768px) {
            ...
            #three60-hp-root .proof-item::after {
                display: none;
            }
            ...
            #three60-hp-root.mob-nav-open .nav-links {
                display: flex;
            }
            ...
            #three60-hp-root .nav-r .btn-nav-pri {
                display: none;
            }
        }
    </style>
...
<body>
    <div id="three60-hp-root">
        ...
        <nav class="nav">
            <div class="container nav-in">
                ...
                <div class="switcher">
                    <button class="sw-btn on-sf" id="sw-sf" onclick="setCRM('sf')">Salesforce</button>
                    <button class="sw-btn" id="sw-zo" onclick="setCRM('zo')">Zoho CRM</button>
                </div>
                <div class="nav-links">
                    <!-- Products -->
                    <div class="ni">
        ...
        <!-- ═══ SECTION 1: HERO ═══ -->
        <section id="hero-sec" class="hero sf">
            <div class="container">
                <div class="h-pill mb-4">
                    <span class="dot-sm dot-hero me-2"></span> #1 on AppExchange • 1,200+ Reviews • 16+ Channels
                </div>
                <h1 class="hero-h1 mb-4" id="hero-h1">The #1 SMS & messaging app<br>for <span class="kw-sf" id="h1-kw">Salesforce</span></h1>
                <p class="hero-sub mb-5" id="hero-sub">Transform Salesforce text messaging across 15+ channels and elevate digital engagement with AI agents that help you connect, engage, and convert.</p>
                <div class="d-flex justify-content-center gap-3 mb-1">
                    <button class="btn btn-brand rounded-3 px-4 py-3 fw-bold" id="hero-cta1">Book a demo →</button>
        ...
        <section class="sec py-5">
            <div class="container">
                <div class="row align-items-center g-5">
                    <div class="col-lg-5">
                        <div class="kicker text-uppercase fw-bold mb-3 c-ink2 ls-1" id="in-kicker">Unified Inbox · Salesforce</div>
                        <h2 class="sh2 fw-bold mb-4 fs-32 lh-11" id="in-h">All Conversations. Fully Connected. Inside Your CRM.</h2>
                        <p class="ssub mb-4 c-ink2 lh-16" id="in-p">360 SMS pulls Salesforce SMS, WhatsApp, Instagram, calls, and more into one unified inbox - right inside your CRM. With a powerful Salesforce SMS app, every message stays synced and auto-logged—so nothing gets missed.</p>
                        ...
                        <button class="btn btn-brand rounded-2 px-4 py-3 fw-bold fs-15" id="in-cta">See all features →</button>
                    </div>
                    <div class="col-lg-7">
        ...
        <section class="sec py-5 bg-white">
            <div class="container text-center">
                ...
                <h2 class="sh2 fw-bold mb-3 fs-32 lh-11 ls-n12 c-ink">Everything you need to stay ahead.<br>Nothing you don't.</h2>
                ...
                <div class="card border-0 rounded-4 overflow-hidden mb-5 bg-blue-card blue-card-pad">
                    ...
                    <div class="row g-4 overflow-hidden">
                        ...
                        $blueFeats = [
                            ...
                            ['bi-shield-check', 'Enterprise Compliance Built In', 'TCPA, GDPR, and the rest - handled. Consent, opt-outs, and logging run automatically so your team does not have to think about it.'],
                        ];
        ...
        <section class="sec py-5 bg-fafafa">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <h2 class="sh2 fw-bold mb-4 text-start fs-32" id="ch-h">15+ channels inside 1 Salesforce messaging app</h2>
        ...
        <section class="sec py-5 bg-white">
            <div class="container">
                ...
                <div class="row gx-4 gy-4 gx-lg-5 gy-lg-5">
                    <?php
                    $features = [
                        ['bi-chat-left-dots', '1:1 Messaging', 'Send SMS from Salesforce with 360 SMS. Automate messaging, handle conversations, and scale with powerful Salesforce SMS integration.'],
        ...
        <section class="sec py-5 bg-agents">
            <div class="container py-lg-4">
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <h2 class="fw-bold text-white mb-2 fs-32 ls-n15">AI Agents for Every Team. Scalable.</h2>
                        <h3 class="fw-bold mb-4 fs-36 c-blue-accent ls-n1">Fully automated.</h3>
                        <p class="c-white-50 mb-4 fs-17 lh-16 mw-900">AI Agents run your communication workflows - automating conversations, qualifying leads, transcribing calls, translating interactions, and helping close deals faster, all within your CRM.<span><a href="#" class="text-primary text-decoration-none fw-bold fs-5">→</a></span></p>
                    </div>
                </div>
                <div class="row gx-4 gy-4 gx-lg-5 gy-lg-5 mb-5">
                    ...
                    $agents = [
                        ...
                        ['bi-translate', 'Call Translation', '50+ languages, in real time. Break language barriers, connect with customers in their preferred language, and do not lose deals over a translation gap.'],
                    ];
                    foreach ($agents as $a): ?>
        ...
        <section class="sec" id="getting-started">
            <div class="container">
                <div class="text-center mb-5">
                    ...
                    <h2 class="sh2 fs-32 fw-800 ls-n1" id="gs-h">Send SMS from Salesforce in minutes—no setup headaches</h2>
                    <p class="ssub mx-auto text-muted mw-800 fs-17 lh-16" id="gs-sub">Start using a powerful SMS app for Salesforce without coding or complexity. With seamless Salesforce SMS integration, you can get started and send SMS from Salesforce in just a few simple steps.</p>
                </div>
                <div class="row g-0 border rounded-4 overflow-hidden bg-white shadow-sm">
                    <div class="col-lg-6 border-end">
                        ...
                        ?>
                            <div class="gs-tab <?= $isFirst ? 'active-tab' : '' ?> gs-pad <?= !$isLast ? 'gs-bdr-b' : '' ?>" id="gst-<?= $step[0] ?>" onclick="showGS(<?= $step[0] ?>)" <?= !$isFirst ? 'style="opacity:.6"' : 'style="border-left:3px solid var(--sf)"' ?>>
                                <div class="d-flex align-items-flex-start gap-4">
                                    <div class="gs-step-num sf" id="gsn<?= $step[0] ?>"><?= $step[0] ?></div>
                                    <div>
                                        <div class="gs-step-h"><?= $step[1] ?></div>
                                        <div class="gs-step-p <?= empty($step[3]) ? 'mb-0' : '' ?> c-ink3"><?= $step[2] ?></div>
                                        <?php if (!empty($step[3])): ?>
                                            <ul class="gs-bullets sf mb-0">
        ...
        <section class="py-5 bg-cta c-white" id="cta-bar-10">
            <div class="container py-3">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <h2 class="fw-bold mb-2 fs-32 cta-bar-h">The #1 Salesforce SMS app. Go Live in 2 minutes.</h2>
                        <p class="mb-0 opacity-75 fs-16">Native install. Zero middleware. Zero dev effort.</p>
                    </div>
                    <div class="col-lg-4 text-lg-end mt-4 mt-lg-0">
                        <div class="d-flex flex-wrap gap-3 justify-content-lg-end">
                            <button class="btn btn-light px-4 py-2 fw-bold btn-cta-light c-brand" id="cta-10-btn1">Start Free Trial</button>
        ...
        <section class="sec py-5 bg-fdfdfd">
            <div class="container py-4">
                ...
                <div class="row g-3">
                    <?php
                    $industries = [
                        ['bi-heart-pulse', 'Healthcare & Wellness', 'Send appointment reminders, patient follow-ups, care updates - all through secure Salesforce SMS.'],
                        ...
                        ['bi-people', 'Recruitment', 'Screen candidates, schedule interviews, send updates - two-way Salesforce texting that moves faster than email.'],
                    ...
                    foreach ($industries as $ind): ?>
                        <div class="col-lg-3 col-md-6">
                            <div class="ind-card p-4 h-100 border rounded-4 bg-white shadow-sm">
                                <div class="mb-2 text-primary fs-3"><i class="bi <?= $ind[0] ?>"></i></div>
                ...
                <div class="text-center mt-5">
                    <button class="btn btn-brand px-4 py-2 fw-bold rounded-2 fs-16" id="view-all-ind">View all Industries →</button>
                </div>
            </div>
        </section>
        ...
        <section class="py-5 bg-cta c-white" id="cta-bar-13">
            <div class="container py-3">
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <h2 class="fw-bold fs-32 mb-2 cta-bar-h">Join 60K+ boosting digital ROI worldwide</h2>
                        <p class="mb-0 opacity-75 fs-16">See SMS live demo for Healthcare, Finance, Real Estate, Education, and more</p>
                    </div>
                    <div class="col-lg-4 text-lg-end mt-4 mt-lg-0">
                        <div class="d-flex flex-wrap gap-3 justify-content-lg-end">
                            <button class="btn btn-light px-4 py-2 fw-bold btn-cta-light c-brand" id="cta-13-btn1">Book a Demo</button>
            ...
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="f-desc" id="foot-desc">The #1 rated Salesforce SMS app on AppExchange. SMS, WhatsApp, AI Chatbot — natively inside Salesforce. No middleware, no developer.</p>
                        <a href="#" class="f-badge"><span>📦</span> Also on AppExchange · Salesforce</a>
                        <a href="#" class="f-badge zo"><span>📦</span> Zoho Marketplace · Zoho CRM</a>
                        <div class="f-socials">
                    ...
                    <div class="col-lg-2 col-md-6">
                        ...
                        <?php foreach (['Blog', 'Case Studies', 'Success Stories', 'ello', 'Documents', 'Pro Tips', 'Webinars', 'Whitepapers', 'Events'] as $link): ?>
                            <a href="#" class="f-link"><?= $link ?></a>
                        <?php endforeach; ?>
                    </div>
                    <div class="col-lg-2 col-md-6">
    ...
    <script>
        ...
        function setCRM(mode) {
            currentMode = mode;
            const isSF = mode === 'sf';
            const root = document.getElementById('three60-hp-root');
            const brandColor = isSF ? 'var(--sf)' : 'var(--zo)';

            // Switcher
            document.getElementById('sw-sf').className = 'sw-btn' + (isSF ? ' on-sf' : '');
            document.getElementById('sw-zo').className = 'sw-btn' + (isSF ? '' : ' on-zo');
            document.getElementById('nav-ai').style.display = isSF ? 'flex' : 'none';

            // Mega menus
            updateMegaMenus(isSF);

            // Branding elements
            document.querySelectorAll('.kicker, .st-num, .ind-card i, .ind-link').forEach(el => {
            ...
            // CTA buttons
            document.querySelectorAll('.btn-nav-pri, .btn-brand, .rb-btn').forEach(el => {
                el.style.backgroundColor = isSF ? '#0057B8' : '#C4152A';
            });

            // CTA Bars
            ['cta-bar-10', 'cta-bar-13'].forEach(id => {
                const el = document.getElementById(id);
                if (el) el.style.background = isSF ? '#0056b3' : '#8B0D1D';
            });
            ['cta-10-btn1', 'cta-13-btn1'].forEach(id => {
                const el = document.getElementById(id);
                if (el) el.style.color = isSF ? '#0056b3' : '#8B0D1D';
            });

            // Hero
            const heroSec = document.getElementById('hero-sec');
            if (heroSec) heroSec.className = 'hero ' + (isSF ? 'sf' : 'zo');
            const h1kw = document.getElementById('h1-kw');
            if (h1kw) {
                h1kw.textContent = isSF ? 'Salesforce' : 'Zoho CRM';
                h1kw.className = isSF ? 'kw-sf' : 'kw-zo';
            }
            const heroSub = document.getElementById('hero-sub');
            if (heroSub) heroSub.textContent = isSF ?
                'Transform Salesforce text messaging across 15+ channels and elevate digital engagement with AI agents that help you connect, engage, and convert.' :
                'Bring high-conversion messaging to Zoho CRM. 4 Native channels, AI agents, and zero-code workflow automation.';

            // Channels heading
            const chH = document.getElementById('ch-h');
            if (chH) chH.textContent = isSF ? '15+ channels inside 1 Salesforce messaging app' : '4 Core channels inside 1 Zoho messaging app';

            updateText(isSF);
        }

        function updateMegaMenus(isSF) {
            const mcC = document.getElementById('mc-channels'),
                mcF = document.getElementById('mc-features');
            if (isSF) {
                if (mcC) mcC.innerHTML = '<div class="mh">Channels</div><a href="#" class="mi"><div class="mi-ic bg-icon-blue">💬</div><div><div class="mi-t">SMS for Salesforce</div><div class="mi-s">1-on-1 and bulk SMS texting</div></div></a><a href="#" class="mi"><div class="mi-ic bg-icon-green">💚</div><div><div class="mi-t">WhatsApp for Salesforce</div><div class="mi-s">Business messaging, templates</div></div></a><a href="#" class="mi"><div class="mi-ic bg-icon-indigo">📞</div><div><div class="mi-t">CTI Telephony</div><div class="mi-s">Click-to-dial, call forwarding</div></div></a><a href="#" class="mi-more">→ View All Channels</a>';
                if (mcF) mcF.innerHTML = '<div class="mh">Features</div><a href="#" class="mi"><div class="mi-ic bg-icon-blue">⚡</div><div><div class="mi-t">Automated Messaging</div><div class="mi-s">Flows, triggers, zero code</div></div></a><a href="#" class="mi"><div class="mi-ic bg-icon-red">📊</div><div><div class="mi-t">Bulk Messaging</div><div class="mi-s">Send to thousands at once</div></div></a><a href="#" class="mi-more">→ View All Features</a>';
            } else {
                if (mcC) mcC.innerHTML = '<div class="mh">Channels</div><a href="#" class="mi"><div class="mi-ic bg-icon-red">💬</div><div><div class="mi-t">SMS for Zoho CRM</div><div class="mi-s">1-on-1 and bulk SMS texting</div></div></a><a href="#" class="mi"><div class="mi-ic bg-icon-green">💚</div><div><div class="mi-t">WhatsApp for Zoho</div><div class="mi-s">Business messaging, templates</div></div></a><a href="#" class="mi-more zo">→ View All Channels</a>';
                if (mcF) mcF.innerHTML = '<div class="mh">Features</div><a href="#" class="mi"><div class="mi-ic bg-icon-yellow">⚡</div><div><div class="mi-t">Workflow Automation</div><div class="mi-s">Trigger SMS from Zoho events</div></div></a><a href="#" class="mi-more zo">→ View All Features</a>';
            }
        }

        function updateText(isSF) {
            const gsH = document.getElementById('gs-h');
            if (gsH) gsH.textContent = isSF ? 'Send SMS from Salesforce in minutes—no setup headaches' : 'Send SMS from Zoho in minutes—zero frustration';
            const gsSub = document.getElementById('gs-sub');
            if (gsSub) gsSub.textContent = isSF ?
                'Start using a powerful SMS app for Salesforce without coding or complexity. With seamless Salesforce SMS integration, you can get started and send SMS from Salesforce in just a few simple steps.' :
                'Empower your team with a native Zoho CRM SMS app that installs in seconds. No middleware, no API setup—just pure native messaging built for Zoho users.';
        }

        function showGS(n) {
            activeGS = n;
            const isSF = currentMode === 'sf',
                color = isSF ? 'var(--sf)' : 'var(--zo)';
            for (let i = 1; i <= 4; i++) {
                ...
                if (num) {
                    num.className = 'gs-step-num ' + (isSF ? 'sf' : 'zo');
                    num.style.background = isSF ? 'var(--sf)' : 'var(--zo)';
                }
            }
        }
