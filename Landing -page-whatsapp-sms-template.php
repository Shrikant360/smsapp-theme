...
/**
 * Template Name: Whatsapp for SMS LP
...
<style>
    ...
    body:has(.sms-lp) {
        ...
        --lp-green: #22a06b;
        --lp-white: #ffffff;
        --lp-footer-bg: url('https://360smsapp.com/wp-content/uploads/2026/06/footer-bg-img-scaled.webp');
...
<header class="lp-sticky-header">
    <div class="lp-header-inner">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="lp-logo">
            <img src="https://360smsapp.com/wp-content/uploads/2019/07/360_sms_-app_logo.png"
                alt="360 SMS App"
                width="180"
                height="44"
                loading="eager">
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 mb-5">
                    <div class="lp-hero-badge">
                        ...
                        #1 Native Salesforce Sms WhatsApp Solution 
                    </div>

                    <h1>WhatsApp Integration in Salesforce with <br><span class="text-primary">360 SMS App</span></h1>
                    <!--<p class="lp-hero-sub">The #1 rated Salesforce SMS app on AppExchange. Send SMS, WhatsApp, and 15+ channels natively inside Salesforce — no middleware, no developer required.</p>-->
                    <a href="#lp-contact-form" class="btn btn-lp-coral lp-scroll">Book a demo</a>
                </div>
                <div class="col-lg-6 text-center text-lg-end">
                    <img src="https://360smsapp.com/wp-content/uploads/2026/06/zoho-whts-img.png"
   ...
   <section class="lp-trusted py-5">
            ...
            <div class="col-12">
                ...
                <div class="lp-logo-scroller" aria-label="Client logos">
                    <div class="lp-logo-track d-flex align-items-center">
                        ...
                        <?php
                        $lp_client_logos = [
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-16ldpi-1.png', 'Morgan'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-21ldpi.png', 'Abbott'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-3ldpi-1.png', 'Unicef'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-10ldpi.png', 'Pagegroup'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-13ldpi.png', 'Lennar'],
                            ['https://360smsapp.com/wp-content/uploads/2023/10/American-red-Cross.png', 'American Red Cross'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-9ldpi.png', 'Fairway'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-5ldpi-1.png', 'ecornell'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/layer1ldpi.png', 'Audi'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-4ldpi-1.png', 'MSD'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-2ldpi-1.png', 'Boys & Girls club'],
                            ['https://360smsapp.com/wp-content/uploads/2026/06/Asset-20ldpi.png', 'Credit Union of Texas'],
                        ];
    ...
    <section class="lp-leadgen" id="lp-contact-form">
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <h2>Turn Everyday Conversations into Growth Opportunities </h2>
                    <p class="lp-leadgen-desc">Customers are already on WhatsApp. Meet them there with personalized conversations, automated engagement, and AI-powered support — all managed directly within Salesforce. </p>
                    <ul class="lp-check-list">
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>100% native to Salesforce — customer data stays securely inside your org</strong></span></li>
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>Personalized WhatsApp engagement — meaningful journey at every stage</strong></span></li>
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>Bulk WhatsApp messaging at scale— reach millions without manual effort</strong></span></li>
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>AI-powered conversations — AI replies, 24/7 engagement, and translation </strong></span></li>
                    </ul>
    ...
    <!-- <section class="lp-comm-suite">
        <div class="container">
            ...
            <img src="https://360smsapp.com/wp-content/uploads/2026/06/end-to-end-communication.webp"
    ...
    <section class="lp-feature-grid">
        <div class="container">
            ...
            <p class="sub">Everything you need to turn Salesforce WhatsApp into a powerful customer engagement channel.</p>
            <div class="row g-4 lp-feature-grid-cards">
                <?php
                $feature_cards = [
                    ['bi-chat-square-dots', 'Two-Way WhatsApp Messaging', 'Engage customers in real time with personalized WhatsApp conversations from Salesforce. Build stronger relationships with every interaction.'],
                    ['bi-send', 'WhatsApp Campaigns & Journeys', 'Launch campaigns and automate customer journeys with point-and-click. Send WhatsApp from Salesforce and reach the right audience at the right time.'],
                    ['bi-heart', 'Compliance Built In', 'Manage consent preferences automatically to maintain compliant WhatsApp communication and reduce regulatory risk.'],
                    ['bi-shield-check', 'No-code Surveys & Chatbots', 'Create interactive surveys, chatbots, polls, and automated conversations without coding. Deliver personalized responses based on customer inputs.'],
                    ['bi-link-45deg', 'Link Tracking & Analytics', 'Shorten, brand, and track every WhatsApp link to measure engagement, understand customer intent, and optimize follow-ups with actionable insights.'],
                    ['bi-clock', 'Conversation Manager', 'Edit records, filter responses by keywords, send bulk messages, all from a single window console without switching tabs and experience productivity boost.'],
                ];
    ...
    <section class="lp-dark-highlight">
        <div class="container">
            <h2 class="lp-dark-heading">AI-Powered Salesforce WhatsApp Integration to Convert</h2>
            <div class="row lp-dark-row g-5">
                <div class="col-lg-6 lp-dark-cards-col">
                    <div class="lp-dark-cards">
                        <?php
                        $dark_feats = [
                            ['bi-lightning-charge', 'AI Reply Suggestions', 'Generate context-aware WhatsApp replies in seconds, helping agents respond faster and maintain personalized customer conversations.'],
                            ['bi-bar-chart', 'Conversation Analysis', 'Analyze WhatsApp conversations in real time to uncover sentiment, engagement patterns, and key customer insights.'],
                            ['bi-globe2', 'Language Translation', 'Communicate confidently with customers in 50+ languages through real-time translation directly within WhatsApp conversations.'],
                            ['bi-activity', 'Multichannel Drip Campaigns', 'Receive AI-powered suggestions to optimize follow-ups, customer journeys, and engagement strategies for better outcomes.'],
                ...
                <div class="col-lg-6 lp-dark-img-col d-flex align-item-center justify-content-center">
                    <div class="lp-dark-sticky">
                        <img src="https://360smsapp.com/wp-content/uploads/2026/06/AI-agent-img.webp"
    ...
    <section class="lp-results">
        <div class="container">
            <h2>The ROI to Expect with 360 SMS WhatsApp for Salesforce</h2>
            <!--<p class="sub">Real numbers from real teams using 360 SMS App inside Zoho.</p>-->
            <div class="row g-4">
                <?php
                $results = [
                    ['47%', 'More lead counts'],
                    ['33%', 'Increase in deal closures'],
    ...
    <section class="lp-trusted lp-badge-trusted">
        <div class="container">
            <!--<h2 class="lp-trusted-title">Certifications</h2>-->
            <div class="lp-logo-scroller" aria-label="Awards and partner badges">
                <div class="lp-logo-track">
                    <?php
                    $lp_award_badges = [
                        ['https://360smsapp.com/wp-content/uploads/2025/08/unnamed-79-1.png', 'Industry award badge'],
                        ['https://360smsapp.com/wp-content/uploads/2025/08/salesforce-available-appexchange-1.png', 'Available on Salesforce AppExchange'],
                        ['https://360smsapp.com/wp-content/uploads/2025/08/Group-308.png', 'Partner award badge'],
                        ['https://360smsapp.com/wp-content/uploads/2025/08/Group-307.png', 'Partner award badge'],
                        ['https://360smsapp.com/wp-content/uploads/2025/08/Group-306.png', 'Partner award badge'],
                        ['https://360smsapp.com/wp-content/uploads/2025/08/Group-305.png', 'Partner award badge'],
                        ['https://360smsapp.com/wp-content/uploads/2025/08/Group-304.png', 'Partner award badge'],
                    ];
                    $lp_award_badges_doubled = array_merge($lp_award_badges, $lp_award_badges);
    ...
    <!--    <div class="container">-->
    <!--        <img src="https://360smsapp.com/wp-content/uploads/2026/06/Picture-logo.webp"-->
    ...
    <section class="lp-compare">
        <div class="container">
            <h2>Why Teams Choose 360 SMS WhatsApp for Salesforce</h2>
    ...
    <footer class="lp-site-footer">
        <div class="container">
            <img src="https://360smsapp.com/wp-content/uploads/2026/01/360-SMS-logo-white.png"
                alt="360 SMS App"
