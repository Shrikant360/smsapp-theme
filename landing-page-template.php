...
/**
 * Template Name: Landing Page New PPC
...
<style>
    ...
    body:has(.sms-lp) {
        ...
        --lp-green: #22a06b;
        --lp-white: #ffffff;
        --lp-footer-bg: url('/wp-content/uploads/2026/06/footer-bg-img-scaled.webp');
    ...
    /* Comparison table value text styles */
    .sms-lp .lp-val-yes {
        color: var(--lp-green);
        font-weight: 700;
        font-size: 14px;
...
<header class="lp-sticky-header">
    <div class="lp-header-inner">
        <a href="<?php echo esc_url(home_url('/')); ?>" class="lp-logo">
            <img src="/wp-content/uploads/2019/07/360_sms_-app_logo.png"
                alt="360 SMS App"
                width="180"
                height="44"
                loading="eager">
...
<main class="sms-lp">
        ...
        <div class="container">
            <div class="row align-items-center g-5 justify-content-center">
                ...
                <div class="col-lg-6 text-center text-lg-end">
                    <img src="/wp-content/uploads/2026/06/hero-img.webp"
        ...
        <div class="container">
            ...
            <div class="lp-logo-scroller" aria-label="Client logos">
                <div class="lp-logo-track">
                    <?php
                    $lp_client_logos = [
                        ['/wp-content/uploads/2026/09/Asset-16ldpi-1.png', 'Morgan'],
                        ['/wp-content/uploads/2026/09/Asset-21ldpi.png', 'Abbott'],
                        ['/wp-content/uploads/2026/09/Asset-3ldpi-1.png', 'Unicef'],
                        ['/wp-content/uploads/2026/09/Asset-10ldpi.png', 'Pagegroup'],
                        ['/wp-content/uploads/2026/09/Asset-13ldpi.png', 'Lennar'],
                        ['/wp-content/uploads/2026/09/American-red-Cross.png', 'American Red Cross'],
                        ['/wp-content/uploads/2026/09/Asset-9ldpi.png', 'Fairway'],
                        ['/wp-content/uploads/2026/09/Asset-5ldpi-1.png', 'ecornell'],
                        ['/wp-content/uploads/2026/09/layer1ldpi.png', 'Audi'],
                        ['/wp-content/uploads/2026/09/Asset-4ldpi-1.png', 'MSD'],
                        ['/wp-content/uploads/2026/09/Asset-2ldpi-1.png', 'Boys & Girls club'],
                        ['/wp-content/uploads/2026/09/Asset-20ldpi.png', 'credit union of texas'],
                    ];
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between g-5">
                <div class="col-lg-6">
                 ...
                 <div class="col-lg-5"  id="lp-contact-form" >
                    <div class="lp-form-card p-4 pt-5 bg-white rounded-3">
                        <!--<h3 class="text-center mb-4" style="display:block !important">-->
                        <!--    Get Started With Your Free Trial-->
                        <!--</h3>-->
                        <p class="form-sub text-muted">Fill out the form and our team will reach out within an hour.</p>
    ...
    <section class="lp-comm-suite">
        <div class="container">
            ...
            <img src="/wp-content/uploads/2026/09/end-to-end-communication.webp"
            ...
            <div class="row lp-dark-row g-5 align-items-center">
                ...
                <div class="col-lg-6 lp-dark-img-col">
                    <div class="lp-dark-sticky">
                        <img src="/wp-content/uploads/2026/09/stop-losing-details-section-img-1.png"
        ...
        <div class="container">
            ...
            <div class="lp-logo-scroller" aria-label="Awards and partner badges">
                <div class="lp-logo-track">
                    <?php
                    $lp_award_badges = [
                        ['/wp-content/uploads/2025/08/unnamed-79-1.png', 'Industry award badge'],
                        ['/wp-content/uploads/2025/08/salesforce-available-appexchange-1.png', 'Available on Salesforce AppExchange'],
                        ['/wp-content/uploads/2025/08/Group-308.png', 'Partner award badge'],
                        ['/wp-content/uploads/2025/08/Group-307.png', 'Partner award badge'],
                        ['/wp-content/uploads/2025/08/Group-306.png', 'Partner award badge'],
                        ['/wp-content/uploads/2025/08/Group-305.png', 'Partner award badge'],
                        ['/wp-content/uploads/2025/08/Group-304.png', 'Partner award badge'],
                    ];
    ...
    <!--    <div class="container">-->
    <!--        <img src="/wp-content/uploads/2026/06/Picture-logo.webp"-->
            ...
            <div class="table-responsive">
                <table class="lp-compare-table">
                    ...
                    <tbody>
                        <?php
                        $compare_rows = [
                            /* [0] Feature  [1] Our text  [2] Our style  [3] Their text  [4] Their style */
                            ['24/7 Support',                    'Free',          'lp-val-yes', 'Paid add-on',        ''],
                            ['Natively built on Salesforce',    'Yes',           'lp-val-yes', 'Often middleware',   'lp-val-no'],
                            ['Salesforce cloud support',        'All Clouds',    'lp-val-yes', 'Limited',            ''],
                            ['Messaging channels',              '15+ Channels',  'lp-val-yes', '3–4 Channels',       ''],
                            ['No-code chatbot',                 'Yes',           'lp-val-yes', 'Complex setup',      ''],
                            ['AI capabilities',                 'Yes',           'lp-val-yes', 'Limited / No',       'lp-val-no'],
                            ['Multi-channel drip campaigns',    'Yes',           'lp-val-yes', 'Limited',            ''],
                            ['Unified messaging console',       'Yes',           'lp-val-yes', 'No',                 'lp-val-no'],
                            ['GDPR and HIPAA compliance',       'Yes',           'lp-val-yes', 'Varies',             ''],
                        ];
    ...
    <footer class="lp-site-footer">
        <div class="container">
            <img src="/wp-content/uploads/2026/01/360-SMS-logo-white.png"
                alt="360 SMS App"
