...
.sms-lp .btn-lp-coral:focus {
    background-color: var(--lp-coral-hover);
    color: var(--lp-white);
}
...
.sms-lp .lp-logo-item {
    ...
    transition: box-shadow 0.2s ease, border-color 0.2s ease;
        margin: 0 8px; /* margin spacing to prevent loop jitter */
}
...
<main class="sms-lp">
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 mb-5">
                    ...
                    <h1>Turn Leads Into Revenue With <span class="text-primary">360 SMS App</span>  For Salesforce</h1>
                ...
                <div class="col-lg-6 text-center text-lg-end">
                    <img src="https://360smsapp.com/wp-content/uploads/2026/06/hero-img.webp"
    ...
    <section class="lp-trusted">
        <div class="container">
            <h2 class="lp-trusted-title">Trusted by 3,000+ Businesses Worldwide</h2>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    ...
                    <p class="lp-leadgen-desc">Stop losing deals to slow follow-ups. 360 SMS App brings every conversation into Salesforce — so your team responds faster, nurtures smarter, and closes more revenue.</p>
                    <ul class="lp-check-list">
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>100% native to Salesforce</strong> — no middleware, no external tools</span></li>
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>15+ messaging channels</strong> — SMS, WhatsApp, Messenger, Instagram &amp; more</span></li>
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>AI-powered automation</strong> — suggestions, translation, and drip campaigns</span></li>
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>Enterprise compliance built in</strong> — TCPA, GDPR, HIPAA ready</span></li>
                    </ul>
    ...
    <section class="lp-dark-highlight">
        <div class="container">
            <h2 class="lp-dark-heading">AI and AI Agents at Every Step — Do More in Less Time </h2>
            <div class="row lp-dark-row g-5">
                <div class="col-lg-6 lp-dark-cards-col">
                    <div class="lp-dark-cards">
                        <?php
                        $dark_feats = [
                            ['bi-lightning-charge', 'AI reply suggestions', 'Context-aware replies drafted in seconds during ongoing live conversations. Your team responds faster without losing quality.'],
                            ['bi-bar-chart', 'Conversation analysis', 'Analysis in real time: key trends, sentiment, and engagement insights surfaced where decisions are made.'],
                            ['bi-globe2', 'Language translation', 'Communicate confidently in 50+ languages across channels in real time. No manual translation delays.'],
                            ['bi-activity', 'Multichannel drip campaigns', 'Personalized drip suggestions for smarter follow-ups and engagement sequences built across every channel.'],
                ...
                <div class="col-lg-6 lp-dark-img-col">
                    <div class="lp-dark-sticky">
                        <img src="https://360smsapp.com/wp-content/uploads/2026/06/stop-losing-details-section-img-1.png"
    ...
    <section class="lp-results">
        <div class="container">
            ...
            <p class="sub">Real-time results from top brands using 360 SMS App for Salesforce.</p>
            <div class="row g-4">
                <?php
                $results = [
                    ['57%', 'Higher customer engagement'],
                    ['45%', 'More leads converted'],
    ...
    <section class="lp-compare">
        <div class="container">
            <h2>Why Teams Choose 360 SMS Over Others</h2>
                ...
                <table class="lp-compare-table">
                    ...
                    <tbody>
                        ...
                        $compare_rows = [
                            ...
                            ['15+ messaging channels', 'yes', 'partial', 'Limited channels'],
                            ['AI capabilities', 'yes', 'no'],
                            ['24/7 free support', 'yes', 'no'],
                            ['No middleware required', 'yes', 'no'],
                            ['1,200+ AppExchange reviews', 'yes', 'no'],
                            ['Link tracking &amp; analytics', 'yes', 'partial', 'Basic only'],
                            ['Compliance (TCPA, GDPR, HIPAA)', 'yes', 'partial', 'Varies'],
                            ['Setup in under 2 minutes', 'yes', 'no'],
                        ];
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="lp-col-highlight">
                                    <?php if ($ours === 'yes') : ?>
                                        <i class="bi bi-check-circle-fill lp-check-yes" aria-label="Yes"></i>
                                    <?php else : ?>
                                        <span class="lp-partial"><?php echo esc_html($partial); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if ($theirs === 'yes') : ?>
                                        <i class="bi bi-check-circle-fill lp-check-yes" aria-label="Yes"></i>
                                    <?php elseif ($theirs === 'partial') : ?>
                                        <span class="lp-partial"><?php echo esc_html($partial); ?></span>
                                    <?php else : ?>
                                        <i class="bi bi-x-circle-fill lp-check-no" aria-label="No"></i>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
