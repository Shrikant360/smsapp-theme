...
═══════════════════════════════════════════ */
    ...
    /* ═══════════════════════════════════════════
     SECTION 9 — MEET THE MINDS (LEADERSHIP + FORM)
  ═══════════════════════════════════════════ */
    /* ═══════════════════════════════════════════
    ...
    <div class="agentforce-hero-container">
      ...
      <div class="agentforce-hero-left">
        <div class="agentforce-logo-row">
          <span style="margin-top: 15px; font-size:30px">Join Us At</span>
          <div class="agentforce-logo">
            <img src="https://360smsapp.com/wp-content/uploads/2026/03/Logo-NYC-wh-1.png">
            
          </div>
        </div>
			
        <h1>Experience  the Agentic Future of Digital Communication<span><br><span style="font-weight:normal">Go-Live in 20 Minutes</span></h1>
        
        <div class="agentforce-subtitle">See AI Agents Live in Action</div>
        <!-- <div class="agentforce-subtitle">Booth No.</div> -->
      ...
      <div class="agentforce-hero-right">
        <div class="agentforce-form-card">
          <div class="agentforce-form-header">
            <h3 style="color:black;">See AI Agents Live At</h3>
            <h3 style="font-weight:normal;">New York World Tour</h3>
          </div>
...
═══════════════════════════════ -->
  <div class="slider-section mt-5">
    <h2 class="section-title">Meet Customers Where They Engage</h2>
...
═══════════════════════════════ -->
      ...
      <div class="section-row">
        ...
        <div class="cards-col">
          <div class="agent-card">
            <h3>AI Agent for Call</h3>
            <p>Nurture and qualify leads and book demos through human-like conversations on calls. <a href="https://360smsapp.com/conversational-ai-voice-agent/" target="_blank" class="learn-more">Learn more</a></p>
          </div>
          <div class="agent-card">
            <h3>AI Powered Chatbot</h3>
            <p>Automate customer engagement 24/7, qualify leads and fill lead pipeline faster. <a href="https://360smsapp.com/360-llm-ai-chat-assistant/" target="_blank" class="learn-more">Learn more</a></p>
          </div>
          <div class="agent-card">
            <h3>Call Transcription Agent</h3>
            <p>Convert live calls into accurate transcripts and offer real-time AI guidance to teams using. <a href="https://360smsapp.com/aiva-ai-agent-call-coaching-transcription/" target="_blank" class="learn-more">Learn more</a></p>
          </div>
          <div class="agent-card">
            <h3>Real-time Call Translation Agent</h3>
            <p>Translate live conversation across 50+ languages in real time & eliminate language barriers. <a href="https://360smsapp.com/ai-connect-live-call-translating-agent/" target="_blank" class="learn-more">Learn more</a></p>
          </div>
          <div class="agent-card">
            <h3>AI Agent for Recruitment</h3>
            <p>Accelerate hiring by identifying best-fit candidates and generating interview questions. <a href="https://360smsapp.com/mira-ai-agent-recruitment-tool/" target="_blank" class="learn-more">Learn more</a></p>
          </div>
          <div class="agent-card">
            <h3>Metadata Creation & Deployment Agent</h3>
            <p>Automate Salesforce admin and development tasks like creating fields, reports, etc. <a href="https://360smsapp.com/automated-metadata-generator-archbuddy-ai/" target="_blank" class="learn-more">Learn more</a></p>
          </div>
          <div class="agent-card">
            <h3>Lead-gen Agent for LinkedIn</h3>
            <p>Generate pipeline by parsing requirements and automating outreach on LinkedIn. <a href="https://360smsapp.com/linkedin-lead-parsing-ai-agent/" target="_blank" class="learn-more">Learn more</a></p>
          </div>
          <div class="agent-card">
            <h3>Pre-sales Document Parsing Agent</h3>
            <p>Reduce presales TAT with auto-analysis of RFPs, case studies, and estimates. <a href="https://360smsapp.com/pre-sales-document-parsing-ai-agent/" target="_blank" class="learn-more">Learn more</a></p>
          </div>
        </div><!-- /cards-col -->
        <div class="sticky-col" id="stickyPanel">
          <h2>Agentforce-Powered Multichannel Engagement  </h2>
          <img src="https://360smsapp.com/wp-content/uploads/2026/03/How-agentforce-work-Data-Cloud-1-1.png" alt="Agentforce Compatibility Across Channels" />
          <br />
  ...
  <!-- ═══════════════════════════════════════════
     SECTION 4 — DEMO / PRODUCT SCREENSHOT
     heading · CTA button · image
═══════════════════════════════════════════ -->
  <section class="demo-section" id="df_footer">
    <div class="container" style="max-width: 960px;">

      <h2 class="demo-heading">
        Experience Engagement, Sales, and Service AI Agents Live in New York 
      ...
      <div class="demo-img-wrap">
        <img
          src="<?php echo esc_url(get_post_meta($post_id, 'demo_screenshot', true) ?: 'https://360smsapp.com/wp-content/uploads/2026/03/imagenyc.webp'); ?>"
...
═══════════════════════════════════════════ -->
  <section class="awaits-section mt-5">
    <div class="container" style="max-width: 1100px;">
      ...
      <h3 class="awaits-heading">What Awaits You at Our Booth</h3>

      <div class="row justify-content-center" style="width:80%; max-width:1100px; margin:0 auto;">

        <!-- Left column -->
        <div class="col-12 col-md-6 awaits-col-left">
          <div class="awaits-item">
            <p class="awaits-item-text">Leadership meet-and-greets with our CEO and core team </p>
          </div>
          <div class="awaits-item">
            <p class="awaits-item-text">Live, interactive AI agent demonstrations </p>
          </div>
          <div class="awaits-item">
            <p class="awaits-item-text">Hands-on product walkthroughs you can try instantly </p>
          </div>
        ...
        <div class="col-12 col-md-6 awaits-col-right">
          <div class="awaits-item">
            <p class="awaits-item-text">Dedicated 1:1 time with product specialists </p>
          </div>
          <div class="awaits-item">
            <p class="awaits-item-text">Live use cases showing real business impact </p>
          </div>
          <div class="awaits-item">
            <p class="awaits-item-text">A closer look at what no-code automation can really do </p>
          </div>
        </div>
...
═══════════════════════════════════════════ -->
  <section class="trusted-section mt-5">
    <div class="container" style="max-width:1200px;">
      ...
      <h2 class="trusted-heading">Trusted By 3000+ SMBs &amp; Enterprises Worldwide</h2>
...
═══════════════════════════════════════════ -->
        ...
        <div class="df-testimonial-carousel-track">
          ...
          <div class="df-testimonial-carousel-card">
            ...
            <div class="df-testimonial-carousel-footer">
              <div>
                <h4>Devon Thorne</h4>
                <span>Director of Operations | Health Sync Global</span>
              </div>
          ...
          <div class="df-testimonial-carousel-card">
            ...
            <div class="df-testimonial-carousel-footer">
              <div>
                <h4>Eduardo Dela Rosa</h4>
                <span>RM Integration Analyst | ResMed Ltd</span>
              </div>
          ...
          <div class="df-testimonial-carousel-card">
            ...
            <div class="df-testimonial-carousel-footer">
              <div>
                <h4>Lindsay Fairchild</h4>
                <span>Salesforce Administrator | Bisk Education</span>
              </div>
  ...
  <!-- ═══════════════════════════════════════════
     SECTION 8 — DISCOVER WHAT'S NEXT (CTA BANNER)
     Blue gradient · centred heading · salmon button
═══════════════════════════════════════════ -->
    ...
    <div class="container" style="max-width:900px;">
      <div class="discover-inner">
        ...
        <a href="#df_footer" class="btn-discover">
          Book a Meeting at Agentforce World Tour New York
        </a>
    ...
    <div class="container" style="max-width:1160px; padding:0 24px;">
      <div class="meet-team-inner">
        ...
        <h2 class="meet-team-heading">
          From Vision to Execution — Meet the 360 SMS<br class="d-none d-md-block">
          Team Live in New York
        </h2>

        <img
          class="meet-team-img"
          src="https://360smsapp.com/wp-content/uploads/2026/04/visitior0604-1.png"
          alt="Meet the 360 SMS Team Live in New York"
          loading="lazy" />
...
═══════════════════════════════════════════ -->
    ...
    <div class="container" style="max-width:1160px;">
      <div class="row align-items-center g-4 g-lg-5">
        ...
        <div class="col-12 col-lg-6 book-meeting-left" style="margin-top:90px">
          <h2>Book a Meeting<br>with our Leadership at<br>the New York World Tour</h2>

          <h4 class="transform-text">
            Let's Transform Engagement<br>
            <strong>Agentically!</strong>
          </h4>
        </div>
        ...
        <div class="col-12 col-lg-6">
          <div class="book-meeting-form-card">
            ...
            <div class="bm-card-header">
              <span class="catchup-text">Let's catch up at</span>
              <img src="https://360smsapp.com/wp-content/uploads/2026/03/Logo-NYC-1.png" alt="Agentforce World Tour NYC" class="bm-logo-img" />
            </div>
  ...
  <script>
    ...
    /* ── Section 7: Testimonials — exact original jQuery carousel ── */
    (function initTestimonialCarousel() {
      function init() {
        ...
        // Card width = computed element width + left+right margin (10+10)
        const cardEl = track.children[visibleCards]; // first real card after prepended clones
    ...
    /* ══════════════════════════════════════════════
       ...
       Walks every ancestor of #stickyPanel and removes
       overflow:hidden / auto / scroll — these silently
       break position:sticky in WP themes (TheGem, Avada,
       Divi, OceanWP, etc.)
    ══════════════════════════════════════════════ */
    (function fixSticky() {
