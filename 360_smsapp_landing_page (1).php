...
/**
 * Template Name: 360 SMSAPP landing Page
...
<style>
    ...
    .sms-lp .lp-dark-slider-wrapper {
        position: relative;
        width: 100%;
        padding: 0 54px; /* inner padding to keep buttons inside the column */
        box-sizing: border-box;
    }
    ...
    /* Comparison table text value styles */
    .sms-lp .lp-val-yes {
        color: var(--lp-green);
        font-weight: 700;
        font-size: 14px;
...
<main class="sms-lp">
    ...
    <!-- ═══ HERO ═══ -->
    <section class="lp-hero " id="lp-contact-form">
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6 mb-5">
                    ...
                    <h1>Turn Leads Into Revenue With <span class="text-primary"> SMS360 App</span> For Salesforce</h1>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    ...
                    <p class="lp-leadgen-desc">Stop losing deals to slow follow-ups. SMS360 App brings every conversation into Salesforce — so your team responds faster, nurtures smarter, and closes more revenue.</p>
    ...
    <section class="lp-results">
        <div class="container">
            ...
            <p class="sub">Real-time results from top brands using SMS360 App for Salesforce</p>
            <div class="row g-4">
                <?php
                $results = [
    ...
    <section class="lp-compare">
        <div class="container">
            <h2>Why Teams Choose SMS360 Over Others</h2>
            <div class="table-responsive">
                <table class="lp-compare-table">
                    <thead>
                        <tr>
                            <th scope="col" style="width:40%">Feature</th>
                            <th scope="col" class="lp-col-highlight" style="width:30%">SMS360 App</th>
    ...
    <footer class="lp-site-footer">
        <div class="container">
            ...
            <div class="lp-site-footer-bar">
                <p class="lp-site-footer-copy mb-0">&copy; <?php echo esc_html(gmdate('Y')); ?> SMS360 App &middot; Powered by 360 Degree Cloud Technologies</p>
            </div>
        </div>
    </footer>
