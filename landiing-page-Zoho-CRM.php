...
/**
 * Template Name: 360-sms-app-for-Zoho-CRM
...
<style>
    ...
    body:has(.sms-lp) {
        ...
        --lp-green: #22a06b;
        --lp-white: #ffffff;
        --lp-footer-bg: url('/wp-content/uploads/2026/08/footer-bg-img-scaled-1.webp');
    ...
    .sms-lp .lp-multichannel {
        padding: 72px 0;
        background: #EDF2F9;
        text-align: center;
    }

    .sms-lp .lp-multichannel h2 {
        font-size: clamp(28px, 3.5vw, 38px);
        font-weight: 800;
        color: var(--lp-primary);
        margin-bottom: 10px;
    ...
    .sms-lp .lp-channel-learn:hover {
        color: var(--lp-coral-hover);
    }

    .sms-lp .lp-multichannel-cta {
        margin-top: 48px;
        text-align: center;
    }

    .sms-lp .lp-multichannel-cta .btn-lp-coral {
        font-size: 16px;
        padding: 8px 36px;
    }
...
<main class="sms-lp">
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6 mb-5">
                    <div class="lp-hero-badge">
                        ...
                        Zoho Text Messaging Platform
                    </div>

                    <h1>Turn Leads into Deals with<span class="text-primary"> 360 SMS</span> Zoho CRM Texting</h1>
                ...
                <div class="col-lg-6 text-center text-lg-end">
                    <img src="/wp-content/uploads/2026/08/image-93-2.webp"
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    ...
                    <ul class="lp-check-list">
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>100% data inside your Zoho CRM</strong></span></li>
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>Multichannel engagement across 3 channels</strong></span></li>
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>Unified inbox to deliver connected experiences</strong></span></li>
                        <li><i class="bi bi-check-circle-fill" aria-hidden="true"></i><span><strong>No-code automation — no developer needed</strong></span></li>
                    </ul>
    ...
    <!-- ═══ MULTICHANNEL ZOHO CRM TEXT MESSAGING ═══ -->
    <section class="lp-multichannel">
        <div class="container">
            <h2>Multichannel Zoho CRM Text Messaging</h2>
            <p class="sub">3 Channels. One Platform. Powered by AI.</p>
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="lp-channel-card">
                        <div class="lp-channel-card-top">
                            <div class="lp-channel-icon">
                                <i class="bi bi-chat-fill" aria-hidden="true"></i>
                            </div>
                            <span class="lp-channel-badge">Reliable</span>
                        </div>
                        <h4>SMS</h4>
                        <p>No internet dependency. Reliable messaging that helps with scalable outreach</p>
                        <a href="#lp-contact-form" class="lp-channel-learn lp-scroll">Learn More →</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="lp-channel-card">
                        <div class="lp-channel-card-top">
                            ...
                            <span class="lp-channel-badge">Global</span>
                        </div>
                        <h4>WhatsApp</h4>
                        <p>Globally preferred channel. Media-rich conversations that drives more engagement</p>
                        <a href="#lp-contact-form" class="lp-channel-learn lp-scroll">Learn More →</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="lp-channel-card">
                        <div class="lp-channel-card-top">
                            ...
                            <span class="lp-channel-badge">Visual</span>
                        </div>
                        <h4>MMS</h4>
                        <p>High visual appeal. Capture your audience's attention instantly and connect with impact.</p>
                        <a href="#lp-contact-form" class="lp-channel-learn lp-scroll">Learn More →</a>
                    </div>
                </div>
            </div>
            <div class="lp-multichannel-cta">
                <a href="#lp-contact-form" class="btn btn-lp-coral lp-scroll">Book a demo</a>
            </div>
        </div>
    </section>
    ...
    <section class="lp-feature-grid">
        <div class="container">
            <h2>Eliminate Friction Across Every Customer Conversation</h2>
            <p class="sub">Everything your team needs to turn Zoho CRM into a complete revenue engine</p>
            <div class="row g-4 lp-feature-grid-cards">
                <?php
                $feature_cards = [
                    ['bi-bell', 'Instant Notifications', 'Get instantly notified when someone responds to your message and improve response time.'],
                    ['bi-chat-square-dots', 'Bulk Messaging', 'Reach thousands of contacts at once from Zoho CRM, so teams can launch campaigns faster without manual effort.'],
                    ['bi-shield-check', 'Compliance', 'Automate opt-ins and opt-outs so you can stay compliant, avoiding legal risks and financial penalties.'],
                    ['bi-calendar-check', 'Message Scheduling', 'Schedule messages in advance or send them at the right time, to drive higher engagement.'],
                    ['bi-link-45deg', 'Link Tracking', 'Send shortened, on-brand, and links and track for actionable insights and effective follow-ups.'],
                    ['bi-folder', 'Template Folders', 'Organize templates into folders for quick access, so teams don\'t waste a single minute searching for them.'],
                ];
    ...
    <section class="lp-dark-highlight">
        <div class="container">
            <h2 class="lp-dark-heading">AI in Zoho Workflows. More Work, Less Effort</h2>
            <div class="row lp-dark-row g-5">
                <div class="col-lg-6 lp-dark-cards-col">
                    <div class="lp-dark-cards">
                        <?php
                        $dark_feats = [
                            ['bi-lightning-charge', 'AI-Suggested Replies',  'Get contextual reply suggestions during 1:1 conversations, so you can respond faster and close every chat successfully.'],
                            ['bi-bar-chart',         'Compliance with AI',    'Manage opt-outs based on customer intent, without relying only on keywords, so that no unwanted message goes out. '],
                            ['bi-globe2',            'Templates with AI',     'Create message templates with AI that can help teams engage impactfully without'],
                            ['bi-activity',          'AI ChatAgent',          'Enable AI to respond to incoming messages 24/7, so every inquiry gets immediate'],
                        ];
                ...
                <div class="col-lg-6 lp-dark-img-col">
                    <div class="lp-dark-sticky">
                        <img src="/wp-content/uploads/2026/08/image-94-1.webp"
    ...
    <!--             alt="Zoho AppExchange awards — APAC ISV Partner, Demo Jam Winner, PDO, Summit Partner, GDPR Ready, HIPAA Compliant"-->
    <!--             width="1100"-->
    <!--             height="120"-->
    <!--             loading="lazy">-->
    <!--    </div>-->
    ...
    <section class="lp-compare">
        <div class="container">
            ...
            <p class="sub">Discover what sets 360 SMS apart from other Zoho SMS integration providers </p>
            <div class="table-responsive">
                <table class="lp-compare-table">
                    ...
                    <tbody>
                         ...
                         */
                        $compare_rows = [
                            ['Zoho Native ',                 '100%',          'lp-val-yes', 'Partialy',      'lp-val-neutral'],
                            ['Redirection to external portal ', 'No',           'lp-val-yes', 'Yes', 'lp-val-no'],
                            ['AI-powered Messaging ',     'Yes',    'lp-val-yes', 'No',          'lp-val-no'],
