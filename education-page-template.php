...
/**
 * Template Name: Education Landing Page paid
 * Description: Google Ads 360 SMS education landing page — Bootstrap layout matching Figma mockup.
 *
 * @package SMS360
 */
...
$lp_img = home_url('/wp-content/uploads/2026/09/');
$lp_logo = '/wp-content/uploads/2019/07/360_sms_-app_logo.png';
...
@media (max-width: 767px) {
  .phone1 .iti.iti--allow-dropdown.iti--separate-dial-code {
    ...
    .sms-lp .lp-mobile-cta-icon .bi-mortarboard-fill {
        font-size: 42px;
        line-height: 1;
    }
...
<main class="sms-lp">
            ...
            <div class="row align-items-center justify-content-center g-4 g-lg-5">
                <div class="col-lg-6 lp-hero-copy">
                    ...
                    <div class="lp-badge">
                        ...
                        Built For Educational Institutions On Salesforce
                    </div>
                    <h1>Increase Applications and Enrolments <span class="accent">with Salesforce SMS and Calls</span></h1>
                    <p class="lp-hero-sub">Engage parents and prospective students throughout the admissions journey with AI-powered calling, texting, and automation—all without leaving Salesforce.</p>
                ...
                <div class="col-lg-5 text-center lp-hero-visual-col">
                    <img src="<?php echo esc_url($lp_img . 'Righ-Img-1.webp'); ?>"
                        alt="Admissions team engaging students with Salesforce SMS"
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center g-4 g-lg-5">
                <div class="col-lg-4 lp-trusted-title">
                    <h2>Trusted by 100+ Educational Institutions Worldwide</h2>
                </div>
                <div class="col-lg-6">
                    <div class="row g-3 lp-logo-grid">
                        <?php
                        $logos = [
                            ['/wp-content/uploads/2026/09/layer1ldpi.png', 'Volkswagen'],
                            ['/wp-content/uploads/2026/09/Asset-21ldpi.png', 'Abbott'],
                            ['/wp-content/uploads/2026/09/Asset-3ldpi-1.png', 'Accenture'],
                            ['/wp-content/uploads/2026/09/Asset-4ldpi-1.png', 'Nasdaq'],
                            ['/wp-content/uploads/2026/09/american-redcross.webp', 'American Red Cross'],
                            ['/wp-content/uploads/2026/09/Asset-10ldpi.png', 'PWC'],
                        ];
                        foreach ($logos as $i => $logo) :
                            $item_class = $i === 5 ? ' col-6 col-md-4 lp-logo-desktop-only' : ' col-6 col-md-4';
                        ?>
                            <div class="<?php echo trim($item_class); ?>">
                                <div class="lp-logo-card">
                                    <img src="<?php echo esc_url($logo[0]); ?>" alt="<?php echo esc_attr($logo[1]); ?>" loading="lazy">
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
    ...
    <section class="lp-features px-2" id="admissions-lifecycle">
        <div class="container">
            <div class="text-center">
                <h2 class="lp-section-title">Turn Prospects into Students Across<br> the Admissions Lifecycle</h2>
                <p class="lp-section-sub">Prevent admission drop-offs by connecting with prospective students and parents through calls, SMS, WhatsApp, and 12+ more channels.</p>
            </div>

            <?php
            $steps_a = [
                [
                    'Respond to Student Enquiries Faster',
                    'Automatically send personalized SMS for new enquiries and next steps, with calls for high-intent students needing immediate guidance.',
                    $lp_img . '01-student-admission-conversation-mobile.webp',
                ],
                [
                    'Simplify Student Counselling',
                    'Automate counselling confirmations, campus visit reminders, and follow-up texts, while using calls to answer complex admission-related questions.',
                    $lp_img . '02-admission-cycle-dashboard.webp',
                ],
                [
                    'Keep Applications Moving',
                    'Send automated reminders for incomplete applications, pending documents, and approaching deadlines, with calls to re-engage students at risk of dropping off.',
                    $lp_img . '03-student-profile-management.webp',
                ],
            ];
            $steps_b = [
                [
                    'Inform Students at Every Stage',
                    'Keep prospective students updated on applications and admissions via SMS, while resolving important queries through calls.',
                    $lp_img . '04-student-enquiry-followup-workflow.webp',
                ],
                [
                    'Make Enrollments Seamless',
                    'Share enrolment instructions, fee payment reminders, orientation schedules, and onboarding updates through SMS, with calls for enrolment assistance.',
                    $lp_img . '05-student-document-and-appointment-management.webp',
                ],
                [
                    'Strengthen Student Relationships',
                    'Engage students with personalized messages for events, updates, alumni outreach, re-engagement, and calls when a personal touch matters.',
                    $lp_img . '06-student-relationship-communication-workflow.webp',
                ],
            ];
            ?>
            ...
            <div class="row align-items-center g-4 g-lg-5 lp-feature-block" data-lp-steps>
                <div class="col-lg-6">
                    <div role="tablist" aria-label="Admissions lifecycle steps 1 to 3">
            ...
            <div class="row align-items-center g-4 g-lg-5 lp-feature-block flex-lg-row-reverse" data-lp-steps>
                <div class="col-lg-6">
                    <div role="tablist" aria-label="Admissions lifecycle steps 4 to 6">
    ...
    <section class="lp-results px-2 pb-0">
        <div class="container">
            <h2 class="lp-section-title text-center">Powering Better Outcomes Across Institutions</h2>
            <div class="lp-results-bar">
                    <div class="row g-0">
                        <?php
                        $lp_results = [
                            ['48%', 'Faster Enquiry Response'],
                            ['33%', 'Reduced Application Drop-Offs'],
                            ['39%', 'Higher Student Enrolments'],
                        ];
    ...
    <section class="lp-clouds px-2 pb-0">
        <div class="container text-center">
            <h2 class="lp-section-title mb-3">Simplify Education Communication for Your Salesforce Cloud</h2>
            <p class="eyebrow">Works Wherever Your Teams Works</p>
    ...
    <section class="lp-compare px-2">
        <div class="container">
            <h2 class="lp-section-title text-center mb-4">Why Schools and Universities Choose 360 SMS</h2>
    ...
    <section class="lp-mobile-cta d-md-none px-2" aria-label="Get started">
        <div class="container">
            <div class="lp-mobile-cta-card">
                ...
                <h2>Built for Education.<br>Built on Salesforce.</h2>
    ...
    <section class="lp-bottom px-2">
        <div class="container lp-final">
            <h2>Don’t Let Communication Gaps Cost You an Enrolment</h2>
            <p>Keep every prospective student engaged, every application progressing, and every enrolment opportunity within reach by making every touchpoint count.</p>
            <div class="d-flex flex-wrap justify-content-center gap-3">
                <a <?php echo $lp_demo; ?> class="btn-lp">Book a Personalized Demo</a>
                <a <?php echo $lp_demo; ?> class="btn-lp btn-lp-outline">Talk to an Education Engagement Expert</a>
            </div>
        </div>
