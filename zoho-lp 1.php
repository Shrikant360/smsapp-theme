...
<section class="zoho-integrate">
  <div class="container">
    <div class="row align-items-center justify-content-center">
      <h1 class="fw-bold mb-5 mt-2 text-dark text-center">Enable AI-powered Customer Engagement from Zoho</h1>
      <!-- Left Image -->
...
<section class="zoho-texting py-5">
  <div class="container">
    <h1 class="fw-bold text-dark mb-5 mt-5 text-center">
    ...
    <div class="row align-items-center justify-content-between pt-5">
      ...
      <div class="col-lg-5 mb-4 mb-lg-0">
        ...
        <div class="accordion" id="zohoAccordion1">
          ...
          <!-- Item 3 -->
          <div class="accordion-item mb-3 border-0 shadow-sm rounded-3">
            <h2 class="accordion-header" id="heading1Three">
              <button class="accordion-button collapsed fw-semibold " type="button" data-bs-toggle="collapse"
    ...
    <div class="row align-items-center justify-content-between ">
      ...
      <div class="col-lg-5 mb-4 mb-lg-0">
        ...
        <div class="accordion" id="zohoAccordion2">
          ...
          <!-- Item 1 -->
          <div class="accordion-item mb-3 border-0 shadow-sm rounded-3">
            <h2 class="accordion-header" id="heading2One">
              <button class="accordion-button fw-semibold" type="button" data-bs-toggle="collapse"
          ...
          <!-- Item 2 -->
          <div class="accordion-item mb-3 border-0 shadow-sm rounded-3">
            <h2 class="accordion-header" id="heading2Two">
              <button class="accordion-button collapsed fw-semibold " type="button" data-bs-toggle="collapse"
          ...
          <!-- Item 3 -->
          <div class="accordion-item mb-3 border-0 shadow-sm rounded-3">
            <h2 class="accordion-header" id="heading2Three">
              <button class="accordion-button collapsed fw-semibold " type="button" data-bs-toggle="collapse"
          ...
          <div class="accordion-item border-0 shadow-sm rounded-3">
            <h2 class="accordion-header" id="heading2Four">
              <button class="accordion-button collapsed fw-semibold " type="button" data-bs-toggle="collapse"
    ...
    <div class="row align-items-center justify-content-between ">
      ...
      <div class="col-lg-5 mb-4 mb-lg-0">
        ...
        <div class="accordion" id="zohoAccordion3">
          ...
          <!-- Item 1 -->
          <div class="accordion-item mb-3 border-0 shadow-sm rounded-3">
            <h2 class="accordion-header" id="heading3One">
              <button class="accordion-button fw-semibold" type="button" data-bs-toggle="collapse"
          ...
          <!-- Item 2 -->
          <div class="accordion-item mb-3 border-0 shadow-sm rounded-3">
            <h2 class="accordion-header" id="heading3Two">
              <button class="accordion-button collapsed fw-semibold " type="button" data-bs-toggle="collapse"
          ...
          <!-- Item 3 -->
          <div class="accordion-item border-0 shadow-sm rounded-3">
            <h2 class="accordion-header" id="heading3Three">
              <button class="accordion-button collapsed fw-semibold " type="button" data-bs-toggle="collapse"
...
<section class="zoho-crm-power text-center text-white py-5 mt-5 mx-0 bg-white"
  ...
  <div class="container py-5">
    <div class="row justify-content-center">
      <div class="col-lg-12">
        <h1 class="fw-bold mb-3 " style="letter-spacing:-0.3px;">
  ...
  <div class="container">
    ...
    <div class="row justify-content-center text-center mb-5">
      <div class="col-lg-8 pt-5">
        <h1 class="fw-bold text-dark">Success Stories from 360 SMS Users</h1>
      </div>
    </div>
...
<section class="zoho-benefits py-5">
  <div class="container">
    ...
    <div class="row justify-content-center text-center my-5">
      <div class="col-lg-8 ">
        <h1 class="fw-bold text-dark my-4">Why Integrate 360 SMS with Zoho CRM?</h1>
      </div>
    </div>
    ...
    <div class="row g-4 justify-content-center">
      ...
      <div class="col-md-4 my-5">
        <div class="benefit-card highlight mx-5 p-4 h-100">
          <h1 class="fw-bold text-primary mb-2">50%</h1>
      ...
      <div class="col-md-4 my-5">
        <div class="benefit-card mx-5 p-4 h-100">
          <h1 class="fw-bold text-primary mb-2">53%</h1>
      ...
      <div class="col-md-4 my-5">
        <div class="benefit-card mx-5 p-4 h-100">
          <h1 class="fw-bold text-primary mb-2">35%</h1>
...
<section class="zoho-faq py-5">
  <div class="container">
    ...
    <div class="row justify-content-center text-center mb-5 pb-5">
      <div class="col-lg-8">
        <h1 class="fw-bold text-dark mb-2">FAQs</h1>
  ...
  <div class="container">
    <div class="row align-items-center justify-content-center overflow-hidden bg-white">
      ...
      <div class="col-md-5 p-5">
        <h1 class="fw-bold mb-5" style="color:#b55a3c;">Got a Question?</h1>
